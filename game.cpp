...
{
    grid.Draw();
    currentBlock.Draw(11,11);//blokların konumunu belirler
    switch (nextBlock.id)
    {
    case 3:
        nextBlock.Draw(255,290);// ı blockblokların konumunu belirler
        break;
    
    case 4:
        nextBlock.Draw(255,280);//o block  için konum belirler
        break;
    default:
